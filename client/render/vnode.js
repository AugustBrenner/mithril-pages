...
Vnode.normalize = function(node) {
	//<<<<<<< Modified: Added store to vnode
	if (Array.isArray(node)) return Vnode("[", undefined, undefined, undefined, Vnode.normalizeChildren(node), undefined, undefined)
	if (node != null && typeof node !== "object") return Vnode("#", undefined, undefined, undefined, node === false ? "" : node, undefined, undefined)	
	//=======
